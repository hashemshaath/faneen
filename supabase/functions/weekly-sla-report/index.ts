...
<tr><td style="padding:8px;border-bottom:1px solid #eee"><b>التزام SLA الرد · Response within ${thresholds.target_response_hours ?? 24}h</b></td><td style="text-align:end;color:#059669"><b>${stats.sla_response_compliance_pct}%</b></td></tr>
<tr><td style="padding:8px;border-bottom:1px solid #eee"><b>التزام الإغلاق · Resolution within ${thresholds.target_resolution_hours ?? 72}h</b></td><td style="text-align:end;color:#059669"><b>${stats.sla_resolution_compliance_pct}%</b></td></tr>
<tr><td style="padding:8px"><b>متأخرة مفتوحة · Stale open (> ${thresholds.stale_hours ?? 24}h)</b></td><td style="text-align:end;color:#d97706"><b>${stats.stale_open}</b></td></tr>
</table>
