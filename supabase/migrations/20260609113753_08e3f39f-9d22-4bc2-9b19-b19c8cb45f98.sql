...
BEGIN
  ...
  -- Validate every primary id and collect those that have children
  ...
  -- Validate every secondary id: if ANY selected primary has children, every
  -- secondary must be a child of one of the selected primaries.
  ...
  -- Atomically replace the three managed roles
