          ...
          <div className="relative">
            ...
            <div className="flex items-center gap-4 text-sm text-muted-foreground mb-6 flex-wrap">
              ...
              <div className="flex items-center gap-1">
                <Button variant="ghost" size="sm" onClick={() => shareToSocial('whatsapp')} className="h-8 w-8 p-0 text-muted-foreground hover:text-[hsl(var(--accent))]" title="WhatsApp">
                ...
                <Button variant="ghost" size="sm" onClick={() => shareToSocial('x')} className="h-8 w-8 p-0 text-muted-foreground hover:text-[hsl(var(--accent))]" title="X">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
                </Button>
                <Button variant="ghost" size="sm" onClick={() => shareToSocial('facebook')} className="h-8 w-8 p-0 text-muted-foreground hover:text-[hsl(var(--accent))]" title="Facebook">
                  <svg className="w-4 h-4" viewBox="0 0 24 24" fill="currentColor"><path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/></svg>
                </Button>
                <Button variant="ghost" size="sm" onClick={() => shareToSocial('telegram')} className="h-8 w-8 p-0 text-muted-foreground hover:text-[hsl(var(--accent))]" title="Telegram">
                ...
                <Button variant="ghost" size="sm" onClick={() => shareToSocial('linkedin')} className="h-8 w-8 p-0 text-muted-foreground hover:text-[hsl(var(--accent))]" title="LinkedIn">
              ...
              <Card className="border-border/50 bg-gradient-to-br from-primary/5 to-accent/5">
                <CardContent className="p-4 space-y-3">
                  ...
                  <div className="grid grid-cols-5 gap-1.5">
                    <button onClick={() => shareToSocial('whatsapp')} className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/10 transition-colors group" title="WhatsApp">
                    ...
                    <button onClick={() => shareToSocial('x')} className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/10 transition-colors group" title="X">
                    ...
                    <button onClick={() => shareToSocial('facebook')} className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/10 transition-colors group" title="Facebook">
                    ...
                    <button onClick={() => shareToSocial('telegram')} className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/10 transition-colors group" title="Telegram">
                      <svg className="w-5 h-5 text-muted-foreground group-hover:text-[#0088cc] transition-colors" viewBox="0 0 24 24" fill="currentColor"><path d="M11.944 0A12 12 0 000 12a12 12 0 0012 12 12 12 0 0012-12A12 12 0 0012 0zm4.962 7.224c.1-.002.321.023.465.14a.506.506 0 01.171.325c.016.093.036.306.02.472-.18 1.898-.962 6.502-1.36 8.627-.168.9-.499 1.201-.82 1.23-.696.065-1.225-.46-1.9-.902-1.056-.693-1.653-1.124-2.678-1.8-1.185-.78-.417-1.21.258-1.91.177-.184 3.247-2.977 3.307-3.23.007-.032.014-.15-.056-.212s-.174-.041-.249-.024c-.106.024-1.793 1.14-5.061 3.345-.479.33-.913.49-1.302.48-.428-.008-1.252-.241-1.865-.44-.752-.245-1.349-.374-1.297-.789.027-.216.325-.437.893-.663 3.498-1.524 5.83-2.529 6.998-3.014 3.332-1.386 4.025-1.627 4.476-1.635z"/></svg>
                      <span className="text-[9px] text-muted-foreground">Telegram</span>
                    </button>
                    <button onClick={() => shareToSocial('linkedin')} className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-accent/10 transition-colors group" title="LinkedIn">
