import { Mail, Activity, PlayCircle, ShieldAlert, Stethoscope } from 'lucide-react';
...
const AdminEmailHub = () => (
  <TabbedShell
    ...
    tabs={[
      ...
      { key: 'diagnostics', label: { ar: 'التشخيص', en: 'Diagnostics' }, icon: Stethoscope, loader: () => import('./AdminEmailDiagnostics') },
