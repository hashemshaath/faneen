  ...
  useMultiJsonLd(useMemo(() => {
    ...
    const breadcrumb = {
      ...
      itemListElement: [
        ...
        { '@type': 'ListItem', position: 2, name: bi('الشروط والأحكام', 'Terms & Conditions'), item: 'https://qitaat.com/terms' },
      ],
    };
