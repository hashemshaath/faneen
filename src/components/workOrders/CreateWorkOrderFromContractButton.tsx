...
/**
 * BUSINESS-CORE-8 — Manual "Create work order from contract" affordance.
    ...
    <Card className={className}>
      <CardHeader className="p-4 pb-2">
        <CardTitle className="text-sm">
          {isRTL ? "إنشاء أمر عمل من العقد" : "Create work order from contract"}
        </CardTitle>
      </CardHeader>
...
export default CreateWorkOrderFromContractButton;