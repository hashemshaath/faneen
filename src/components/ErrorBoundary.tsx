...
export class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      ...
      return (
        <div className="min-h-screen bg-background flex items-center justify-center p-4 sm:p-6 relative overflow-hidden" dir="rtl">
          {/* Decorative blurs */}
            ...
            <div className="rounded-3xl border border-border/50 bg-card shadow-xl overflow-hidden">
              ...
              <div className="px-6 sm:px-8 py-6 sm:py-8 text-center space-y-3">
                ...
                <p className="text-sm sm:text-[15px] text-muted-foreground max-w-md mx-auto leading-relaxed">
                  نعتذر — حدث خلل في تحميل هذا الجزء من الصفحة. يمكنك إعادة المحاولة أو العودة للرئيسية،
                  وفريقنا التقني تم إخطاره تلقائياً.
                </p>
              ...
              <div className="border-t border-border/40 bg-muted/20">
                ...
                >
                  <span className="inline-flex items-center gap-1.5">
                    ...
                    تفاصيل تقنية ({diag.length} حدث في السجل)
                  </span>
                  ...
                  <div className="px-6 sm:px-8 pb-5 space-y-3">
                    <div className="flex items-center justify-between gap-2">
                      ...
                      >
                        ...
                        {this.state.copied ? "تم النسخ" : "نسخ التقرير"}
                      </button>
                    </div>
