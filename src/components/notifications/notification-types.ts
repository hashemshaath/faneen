...
export const notificationTypeMeta: Record<string, NotificationTypeMeta> = {
  // Industry-specific
  new_message:         { icon: MessageSquare, colorClass: 'bg-secondary/10 text-secondary dark:text-secondary', label: { ar: 'رسالة جديدة', en: 'New Message' }, urgency: 'info' },
  contract_created:    { icon: FileText,      colorClass: 'bg-info/10 text-info dark:text-info',     label: { ar: 'عقد جديد', en: 'New Contract' }, urgency: 'important' },
  contract_signed:     { icon: PenLine,       colorClass: 'bg-success/10 text-success dark:text-success', label: { ar: 'عقد تم توقيعه', en: 'Contract Signed' }, urgency: 'info' },
  contract_awaiting:   { icon: Clock,         colorClass: 'bg-warning/10 text-warning dark:text-warning',  label: { ar: 'عقد ينتظر توقيعك', en: 'Awaiting Signature' }, urgency: 'urgent' },
  payment_due:         { icon: CreditCard,    colorClass: 'bg-destructive/10 text-destructive dark:text-destructive',        label: { ar: 'دفعة مستحقة', en: 'Payment Due' }, urgency: 'urgent' },
  stage_completed:     { icon: CheckCircle2,  colorClass: 'bg-success/10 text-success dark:text-success', label: { ar: 'مرحلة اكتملت', en: 'Stage Completed' }, urgency: 'info' },
  stage_awaiting:      { icon: Eye,           colorClass: 'bg-warning/10 text-warning dark:text-warning',  label: { ar: 'مرحلة تنتظر تأكيدك', en: 'Stage Awaiting' }, urgency: 'urgent' },
  new_review:          { icon: Star,          colorClass: 'bg-warning/10 text-warning dark:text-warning', label: { ar: 'تقييم جديد', en: 'New Review' }, urgency: 'info' },
  review_replied:      { icon: Send,          colorClass: 'bg-secondary/10 text-secondary dark:text-secondary', label: { ar: 'رد على تقييمك', en: 'Review Reply' }, urgency: 'info' },
  maintenance_request: { icon: Wrench,        colorClass: 'bg-urgent/10 text-urgent dark:text-urgent', label: { ar: 'طلب صيانة', en: 'Maintenance Request' }, urgency: 'important' },
  maintenance_update:  { icon: Wrench,        colorClass: 'bg-urgent/10 text-urgent dark:text-urgent', label: { ar: 'تحديث صيانة', en: 'Maintenance Update' }, urgency: 'info' },
  ...
  promotion:   { icon: Megaphone,     colorClass: 'bg-secondary/10 text-secondary dark:text-secondary',  label: { ar: 'العروض', en: 'Promotions' }, urgency: 'info' },
  message:     { icon: MessageSquare, colorClass: 'bg-secondary/10 text-secondary dark:text-secondary',  label: { ar: 'الرسائل', en: 'Messages' }, urgency: 'info' },
  maintenance: { icon: Wrench,        colorClass: 'bg-urgent/10 text-urgent dark:text-urgent',  label: { ar: 'الصيانة', en: 'Maintenance' }, urgency: 'important' },
