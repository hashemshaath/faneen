 ...
 *
 * Renders three cluster slots in source order: move (up/down), toggle,
 * delete. The caller composes them into the row layout.
 */
...
export const PartnerShowcaseMoveControls: React.FC<
  Pick<PartnerShowcaseRowActionsProps, 'canMoveUp' | 'canMoveDown' | 'onMoveUp' | 'onMoveDown'>
...
export const PartnerShowcaseRowActions: React.FC<
  Pick<PartnerShowcaseRowActionsProps, 'isActive' | 'onToggleShow' | 'onDelete'>
> = ({ isActive, onToggleShow, onDelete }) => {
  const bi = useBi();
  return (
