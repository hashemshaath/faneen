              ...
              >
                <div className="rounded-2xl overflow-hidden border border-border hover:border-gold/40 bg-card transition-all duration-500 hover:shadow-lg hover-scale h-full relative">
                  ...
                  <div className="p-4 space-y-2">
                    ...
                    <h3 className="font-heading font-bold line-clamp-2 group-hover:text-gold transition-colors">
                    ...
                    {/* Footer: provider + views */}
                    <div className="flex items-center justify-between pt-2 border-t border-border/30">
                      {offer.businesses && (
                        <Link
                          to={`/${offer.businesses.username}`}
                          onClick={(e) => e.stopPropagation()}
                          className="flex items-center gap-1.5 text-sm text-gold font-medium hover:underline"
                        >
