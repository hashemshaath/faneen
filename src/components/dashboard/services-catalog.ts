...
export const serviceCatalog: ServiceGroup[] = [
  ...
  },
  {
    ...
    color: 'bg-secondary/10 text-secondary',
    services: [
      { name_ar: 'تركيب رخام أرضيات', name_en: 'Marble Flooring', description_ar: 'توريد وتركيب أرضيات رخام طبيعي ومستورد', description_en: 'Supply and installation of natural and imported marble flooring' },
      { name_ar: 'تركيب جرانيت', name_en: 'Granite Installation', description_ar: 'أعمال جرانيت للأسطح والأرضيات والواجهات', description_en: 'Granite work for countertops, floors and facades' },
      { name_ar: 'أسطح كوارتز', name_en: 'Quartz Countertops', description_ar: 'أسطح كوارتز هندسي للمطابخ والحمامات', description_en: 'Engineered quartz surfaces for kitchens and bathrooms' },
      { name_ar: 'سلالم رخام', name_en: 'Marble Stairs', description_ar: 'تنفيذ سلالم رخام داخلية وخارجية بتصاميم فاخرة', description_en: 'Interior and exterior marble stairs with luxury designs' },
      { name_ar: 'تلميع وجلي رخام', name_en: 'Marble Polishing', description_ar: 'جلي وتلميع وكريستلة الرخام والجرانيت', description_en: 'Marble and granite grinding, polishing and crystallization' },
      { name_ar: 'واجهات حجر', name_en: 'Stone Facades', description_ar: 'واجهات حجر طبيعي ورياض للفلل والمباني', description_en: 'Natural and Riyadh stone facades for villas and buildings' },
    ],
  },
  {
    id: 'insulation',
    name_ar: 'العزل والطاقة',
    name_en: 'Insulation & Energy',
    icon: '🛡️',
    color: 'bg-warning/10 text-warning',
    services: [
      { name_ar: 'عزل حراري للأسطح', name_en: 'Roof Thermal Insulation', description_ar: 'عزل حراري للأسطح بمواد فوم وبيتومين معتمدة', description_en: 'Roof thermal insulation with certified foam and bitumen materials' },
      { name_ar: 'عزل مائي', name_en: 'Waterproofing', description_ar: 'عزل مائي للأسطح والخزانات والحمامات', description_en: 'Waterproofing for roofs, tanks and bathrooms' },
      { name_ar: 'عزل صوتي', name_en: 'Acoustic Insulation', description_ar: 'عزل صوتي للجدران والأسقف للمباني السكنية والتجارية', description_en: 'Acoustic insulation for walls and ceilings in residential and commercial buildings' },
      { name_ar: 'ألواح طاقة شمسية', name_en: 'Solar Panels', description_ar: 'توريد وتركيب ألواح طاقة شمسية للمنازل والمنشآت', description_en: 'Supply and installation of solar panels for homes and facilities' },
      { name_ar: 'سخانات شمسية', name_en: 'Solar Water Heaters', description_ar: 'تركيب سخانات مياه تعمل بالطاقة الشمسية', description_en: 'Installation of solar-powered water heaters' },
      { name_ar: 'فحص ترموغرافي', name_en: 'Thermographic Inspection', description_ar: 'فحص حراري للمباني لاكتشاف نقاط فقد الطاقة', description_en: 'Thermal building inspection to detect energy loss points' },
    ],
  },
  {
    id: 'smart_home',
    name_ar: 'المنازل الذكية',
    name_en: 'Smart Home',
    icon: '🏠',
    color: 'bg-info/10 text-info',
    services: [
      { name_ar: 'أنظمة تحكم ذكي', name_en: 'Smart Control Systems', description_ar: 'تركيب أنظمة منزل ذكي للإضاءة والتكييف والستائر', description_en: 'Smart home systems for lighting, AC and curtains' },
      { name_ar: 'كاميرات مراقبة', name_en: 'CCTV & Surveillance', description_ar: 'كاميرات مراقبة عالية الدقة مع تطبيقات للهاتف', description_en: 'High-resolution CCTV with mobile apps' },
      { name_ar: 'أنظمة إنذار وحريق', name_en: 'Alarm & Fire Systems', description_ar: 'أنظمة إنذار سرقة وحريق متكاملة معتمدة', description_en: 'Integrated certified alarm and fire systems' },
      { name_ar: 'أبواب ذكية', name_en: 'Smart Doors & Locks', description_ar: 'أقفال وأبواب ذكية ببصمة أو رمز', description_en: 'Smart locks and doors with fingerprint or PIN' },
      { name_ar: 'إنترفون مرئي', name_en: 'Video Intercom', description_ar: 'أنظمة إنترفون مرئي مع تكامل الهاتف', description_en: 'Video intercom systems with phone integration' },
      { name_ar: 'شبكات وإنترنت', name_en: 'Networking & Wi-Fi', description_ar: 'تمديد شبكات وأجهزة Wi-Fi احترافية للمنازل والمكاتب', description_en: 'Professional networking and Wi-Fi for homes and offices' },
    ],
  },
  {
    id: 'gypsum',
    ...
    services: [
      { name_ar: 'أسقف جبسية معلقة', name_en: 'Suspended Gypsum Ceilings', description_ar: 'تنفيذ أسقف جبسية معلقة بتصاميم عصرية', description_en: 'Suspended gypsum ceilings with modern designs' },
      { name_ar: 'ديكور جبس بورد', name_en: 'Gypsum Board Decor', description_ar: 'أعمال جبس بورد للجدران والممرات', description_en: 'Gypsum board work for walls and corridors' },
      { name_ar: 'كرانيش وزخارف', name_en: 'Cornices & Moldings', description_ar: 'كرانيش جبس وزخارف كلاسيكية وعصرية', description_en: 'Gypsum cornices and classic/modern moldings' },
      { name_ar: 'دهانات وديكورات', name_en: 'Painting & Wall Finishes', description_ar: 'دهانات داخلية وخارجية وورق جدران فاخر', description_en: 'Interior and exterior paints and luxury wallpaper' },
      { name_ar: 'إضاءة مخفية', name_en: 'Hidden LED Lighting', description_ar: 'تصميم وتركيب إضاءة LED مخفية وسبوت لايت', description_en: 'Hidden LED lighting and spotlight design and installation' },
    ],
  },
  {
    id: 'hvac',
    ...
    color: 'bg-info/10 text-info',
    services: [
      { name_ar: 'تركيب تكييف سبليت', name_en: 'Split AC Installation', description_ar: 'توريد وتركيب وحدات تكييف سبليت بكفاءة عالية', description_en: 'Supply and installation of high-efficiency split AC units' },
      { name_ar: 'تكييف مركزي', name_en: 'Central AC', description_ar: 'تركيب وصيانة أنظمة تكييف مركزي للفلل والمنشآت', description_en: 'Installation and maintenance of central AC systems for villas and facilities' },
      { name_ar: 'تنظيف مكيفات', name_en: 'AC Cleaning', description_ar: 'تنظيف وتعقيم وحدات التكييف بأحدث المعدات', description_en: 'AC unit cleaning and sterilization with the latest equipment' },
      { name_ar: 'سباكة عامة', name_en: 'General Plumbing', description_ar: 'تمديدات سباكة وصيانة شاملة للمنازل والمنشآت', description_en: 'Plumbing extensions and comprehensive maintenance' },
      { name_ar: 'كشف تسربات', name_en: 'Leak Detection', description_ar: 'كشف تسربات المياه بأجهزة حديثة بدون تكسير', description_en: 'Water leak detection with modern equipment without breaking' },
      { name_ar: 'تركيب سخانات', name_en: 'Water Heater Installation', description_ar: 'تركيب وصيانة سخانات مياه كهربائية وغازية', description_en: 'Installation and maintenance of electric and gas water heaters' },
    ],
  },
];
