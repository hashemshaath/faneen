...
/**
 * Phase 5C-3 guard — the next batch of high-density dashboard files must use
...
const FILES = [
  ...
  'src/pages/dashboard/DashboardBlog.tsx',
  'src/pages/dashboard/DashboardSites.tsx',
  'src/pages/dashboard/DashboardSettings.tsx',
];

describe('Phase 5C-3 — Dashboard messages/blog/sites/settings bilingual hygiene', () => {
