...
## Purpose
Future home of all `admin` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the admin domain
- Hooks that orchestrate admin state
...
## Public API
Import from the module barrel (`@/modules/admin`) once exports are added in R1/R2.
