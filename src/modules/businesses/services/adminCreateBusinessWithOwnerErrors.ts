...
const MAP_AR: Record<AdminCreateBizErrorCode, string> = {
  ...
  invalid_owner_mode: 'نمط ربط المالك غير صحيح. الرجاء اختيار وضع "بدون مدير (حساب مؤقت)" أو إعادة المحاولة.',
...
const MAP_EN: Record<AdminCreateBizErrorCode, string> = {
  ...
  invalid_owner_mode: 'Invalid owner binding mode. Please choose "No manager (placeholder account)" or try again.',
