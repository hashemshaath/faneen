...
## Purpose
Future home of all `international` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the international domain
- Hooks that orchestrate international state
...
## Public API
Import from the module barrel (`@/modules/international`) once exports are added in R1/R2.
