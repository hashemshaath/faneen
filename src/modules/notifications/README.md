...
## Purpose
Future home of all `notifications` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the notifications domain
- Hooks that orchestrate notifications state
...
## Public API
Import from the module barrel (`@/modules/notifications`) once exports are added in R1/R2.
