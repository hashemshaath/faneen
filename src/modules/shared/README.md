...
## Purpose
Future home of all `shared` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the shared domain
- Hooks that orchestrate shared state
...
## Public API
Import from the module barrel (`@/modules/shared`) once exports are added in R1/R2.
