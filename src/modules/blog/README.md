...
## Purpose
Future home of all `blog` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the blog domain
- Hooks that orchestrate blog state
...
## Public API
Import from the module barrel (`@/modules/blog`) once exports are added in R1/R2.
