...
export async function listProviderSubscriptions<T = unknown>({
  select = 'id, ref_id, business_id, provider_user_id, plan_id, status, lead_credits_balance, current_period_start, current_period_end, updated_at, plan:provider_plans(id, code, name_ar, lead_credits_per_month), business:businesses!provider_subscriptions_business_id_fkey(id, ref_id, name_ar, user_id, membership_tier)',
  limit = 500,
