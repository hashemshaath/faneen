...
## Purpose
Future home of all `memberships` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the memberships domain
- Hooks that orchestrate memberships state
...
## Public API
Import from the module barrel (`@/modules/memberships`) once exports are added in R1/R2.
