...
export const ADMIN_DASHBOARD_QUICK_ACTIONS: readonly AdminQuickAction[] = [
  ...
  { id: 'qa-operations',    labelAr: 'مركز العمليات',   labelEn: 'Operations Center',   route: '/admin/operations',             icon: Activity },
  { id: 'qa-search',        labelAr: 'تدقيق الموقع',    labelEn: 'Site Audit',          route: '/admin/site-audit',             icon: Search },
  { id: 'qa-ai-center',     labelAr: 'مركز الذكاء',     labelEn: 'AI Center',           route: '/admin/ai-center',              icon: Newspaper },
