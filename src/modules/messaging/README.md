...
## Purpose
Future home of all `messaging` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the messaging domain
- Hooks that orchestrate messaging state
...
## Public API
Import from the module barrel (`@/modules/messaging`) once exports are added in R1/R2.
