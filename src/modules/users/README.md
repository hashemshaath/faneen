...
## Purpose
Future home of all `users` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the users domain
- Hooks that orchestrate users state
...
## Public API
Import from the module barrel (`@/modules/users`) once exports are added in R1/R2.
