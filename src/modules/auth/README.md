...
## Purpose
Future home of all `auth` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the auth domain
- Hooks that orchestrate auth state
...
## Public API
Import from the module barrel (`@/modules/auth`) once exports are added in R1/R2.
