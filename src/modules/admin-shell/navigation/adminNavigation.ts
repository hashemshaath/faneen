...
export const ADMIN_NAV_GROUPS: readonly AdminNavGroup[] = [
  {
    ...
    descriptionAr: 'الصفحة الرئيسية للإدارة مع المؤشرات الحيّة',
    descriptionEn: 'Admin home with live KPIs',
    items: [
  ...
  },
  {
    ...
    labelEn: 'Operations',
    icon: Activity,
    descriptionAr: 'مركز العمليات، الطلبات، العقود والاعتمادات',
    ...
    items: [
      ...
      { id: 'quote-requests', labelAr: 'إدارة الفرص', labelEn: 'Manage Opportunities', route: '/admin/quote-requests', icon: Inbox, hiddenInSidebar: true },
      ...
      { id: 'provider-leads', labelAr: 'الفرص المسندة للمزودين', labelEn: 'Provider Assigned Opportunities', route: '/admin/provider-leads', icon: Inbox, hiddenInSidebar: true },
