...
## Purpose
Future home of all `client-sites` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the client-sites domain
- Hooks that orchestrate client-sites state
...
## Public API
Import from the module barrel (`@/modules/client-sites`) once exports are added in R1/R2.
