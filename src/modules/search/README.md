...
## Purpose
Future home of all `search` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the search domain
- Hooks that orchestrate search state
...
## Public API
Import from the module barrel (`@/modules/search`) once exports are added in R1/R2.
