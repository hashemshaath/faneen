...
## Purpose
Future home of all `barcodes` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the barcodes domain
- Hooks that orchestrate barcodes state
...
## Public API
Import from the module barrel (`@/modules/barcodes`) once exports are added in R1/R2.
