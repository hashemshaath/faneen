...
## Purpose
Future home of all `ai` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the ai domain
- Hooks that orchestrate ai state
...
## Public API
Import from the module barrel (`@/modules/ai`) once exports are added in R1/R2.
