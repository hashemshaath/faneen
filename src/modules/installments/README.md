...
## Purpose
Future home of all `installments` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the installments domain
- Hooks that orchestrate installments state
...
## Public API
Import from the module barrel (`@/modules/installments`) once exports are added in R1/R2.
