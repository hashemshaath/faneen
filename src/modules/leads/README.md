...
## Purpose
Future home of all `leads` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the leads domain
- Hooks that orchestrate leads state
...
## Public API
Import from the module barrel (`@/modules/leads`) once exports are added in R1/R2.
