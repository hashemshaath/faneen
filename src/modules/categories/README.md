...
## Purpose
Future home of all `categories` domain code: pages, components, hooks, services, types, and tests.

## What belongs here (in later phases)
- UI specific to the categories domain
- Hooks that orchestrate categories state
...
## Public API
Import from the module barrel (`@/modules/categories`) once exports are added in R1/R2.
